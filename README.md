...
## How to Play
To get started, press the space key and you'll be sent to the Character Select Screen. Click through the characters using the left or right arrows and select the two you want to choose for game play! After Character 1 is chosen, "yasssss" should print onto the console and "oink" after Character 2. You might need to click a couple times or wait a moment or on the select box due to lag. Character 1 uses A and D for left and right movement, W for jump, and Z for punch. Character 2 uses J and L for left and right movement, I for jump, and M for punch. Each character starts with a certain hp of health and speed, but each received punch causes damage and reduces that damaged character's hp by 10. You can view each character's hp score at the top left and right of the screen. Whichever character's hp reaches zero first loses and an endgame winner screen appears!
